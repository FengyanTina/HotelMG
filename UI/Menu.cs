class Menu
{
        ...
        while (!quit)
        {
            ...
            switch (CustomerChoice)
            {
                ...
                case MenuChoiceCustomer.BookRoom://not working properlly
                    userInput.CustomerBookRoom(customerId);
                    break;
        ...
        foreach (string c in Enum.GetNames(typeof(MenuChoiceEmployee)))
           { 
            Console.WriteLine("[{1}]:  {0,-20} ", c, 
                              Enum.Format(typeof(MenuChoiceEmployee), 
                              Enum.Parse(typeof(MenuChoiceEmployee), c), "d"));
           }
    ...
    public RegisterLoginChoiceUser RegisterLoginSwitch()
    {
        foreach (string c in Enum.GetNames(typeof(RegisterLoginChoiceUser)))
           { 
            Console.WriteLine("[{1}]:  {0,-20} ", c, 
                              Enum.Format(typeof(RegisterLoginChoiceUser), 
                              Enum.Parse(typeof(RegisterLoginChoiceUser), c), "d"));
           }
        // Console.WriteLine("Select one of the options:");
        // int registerLoginInput = int.Parse(Console.ReadLine());
        RegisterLoginChoiceUser choice = (RegisterLoginChoiceUser)userInput.TryGetInt("Select one of the options:");
        return choice;
    }
    ...
    public MenuChoiceCustomer CustomerEnumSwitch()
    {
         foreach (string c in Enum.GetNames(typeof(MenuChoiceCustomer)))
           { 
            Console.WriteLine("[{1}]:  {0,-20} ", c, 
                              Enum.Format(typeof(MenuChoiceCustomer), 
                              Enum.Parse(typeof(MenuChoiceCustomer), c), "d"));
           }
    ...
    public MenuChoiceManager ManagerEnumSwitch()
    {
        foreach (string c in Enum.GetNames(typeof(MenuChoiceManager)))
           { 
            Console.WriteLine("[{1}]:  {0,-20} ", c, 
                              Enum.Format(typeof(MenuChoiceManager), 
                              Enum.Parse(typeof(MenuChoiceManager), c), "d"));
           }
    ...
    public MenuChoiceUser MenuChoiceUserEnumSwitch()
    {
         foreach (string c in Enum.GetNames(typeof(MenuChoiceUser)))
           { 
            Console.WriteLine("[{1}]:  {0,-20} ", c, 
                              Enum.Format(typeof(MenuChoiceUser), 
                              Enum.Parse(typeof(MenuChoiceUser), c), "d"));
           }
