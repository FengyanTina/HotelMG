public class Reservation
{
    ...
    public double date_range { get; set; }
    public double reservation_totalpay { get; set; }

    public override string ToString()
    {
        return $"Reservation: " + reservation_id + "\nCustomer Name: " + customer_fname + " " + customer_lname + "\nEmployee Id: " + employee_id + "\nRoom Type: " + roomType_name + "\nRoom:  " + room_id + "\nPrice: " + room_price + " Kr" + "\nReservation Date:  " + reservation_date.ToShortDateString() + "\nChecking in Date:  " + date_in.ToShortDateString() + "\nChecking out Date:  " + date_out.ToShortDateString() + "\nStaying time span: " + date_range + " " + "day(s)" +  "\nRoom total payment: " + reservation_totalpay + "Kr\n";
